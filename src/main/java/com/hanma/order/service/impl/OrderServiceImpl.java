...
public class OrderServiceImpl implements OrderService {
    ...
    public List<Order> getUserIdOrder(Long userId) {
        ...
        for(int i=0;i<order.size();i++) {
            List<OrderSku> orderSku = orderSkuMapper.getMerchantIdOrder(order.get(i).getOrderId());
        /*再放入order实体的list中*/
    ...
    public List<Order> queryOrderList() {
        ...
        for(int i=0;i<orderList.size();i++){
            ...
            List<OrderSku> merchantIdOrder = orderSkuMapper.getMerchantIdOrder(orderList.get(i).getOrderId());
            /*放入主订单中的list中*/
    ...
    public List<Order> getMerchantIdOrder(Long merchantId) {
        ...
        for(int i=0;i<merchantIdOrder.size();i++) {
            List<OrderSku> orderSku = orderSkuMapper.getMerchantIdOrder(merchantIdOrder.get(i).getOrderId());
        /*再放入order实体的list中*/
